  ...
  const questions = await Question.create([
    {
      ...
      correctOptions: ['a'], selectionMode: 'single', explanation: '15% of 240 = 36 and 20% of 150 = 30. Total = 66.',
    ...
    },
    {
      ...
      correctOptions: ['b'], selectionMode: 'single', explanation: 'Increase is 40. 40/200 × 100 = 20%.',
      defaultMarks: 1, negativeMarks: 0.25, difficulty: 'easy', source: 'original',
    },
    {
      ...
      correctOptions: ['c'], selectionMode: 'single', explanation: 'A book is used for reading; a fork is used for eating.',
      defaultMarks: 1, negativeMarks: 0.25, difficulty: 'easy', source: 'original',
    },
    {
      sectionId: sections[2].id, subjectTag: 'English', topic: 'Vocabulary',
      questionText: 'Choose the words closest in meaning to “Abundant”.',
      options: [{ key: 'a', text: 'Scarce' }, { key: 'b', text: 'Plentiful' }, { key: 'c', text: 'Ample' }, { key: 'd', text: 'Weak' }],
      correctOptions: ['b', 'c'], selectionMode: 'multiple', explanation: 'Abundant means plentiful or available in large quantities.',
      defaultMarks: 1, negativeMarks: 0.25, difficulty: 'easy', source: 'original',
    },
  ]);
